...
float hard_iron[3] = {-14.83, -1.82, -42.73};
float soft_iron[3][3] = {
  {1, 0.032, -0.004},
  {0.032, 1, -0.01},
  {-0.004, -0.01, 1.001}
...
SDCard sd(53);
Atmosphere atm;
WindVane windVane(0, 900, 1900, 2900, true);
Sail sail(8);
Rudder rudder(10);
ESC esc(9);
...
Mesh mesh(4, "0013A20042331868", &atm, &windVane, &sail, &rudder, &esc, &magnetometer, &gpsList, &gps, &control);
